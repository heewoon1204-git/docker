...
단순히 서비스를 사용하는 것이 아니라,

- Docker와 AWS 핵심 서비스를 직접 구축하고
- 장애를 재현하고 원인을 분석하며
- 해결 과정을 문서화하고
- 최종적으로 **실서비스를 가정한 인프라 환경을 직접 설계 및 구축**하는 것을 목표로 학습하고 있습니다.

---

## 📝 Study Log

실습 과정에서 발생한 오류와 해결 과정을 함께 기록하고 있습니다.